...
chmod +x ~/.local/bin/conky-weather.sh ~/.local/bin/wallpaper-time.sh

# Firefox userChrome (requiere el profile correcto)
...
echo "  - Enable Firefox userChrome in about:config:"
echo "    toolkit.legacyUserProfileCustomizations.stylesheets = true"
echo "  - Set layout.css.devPixelsPerPx = 1.2 in about:config"
echo "========================================"
